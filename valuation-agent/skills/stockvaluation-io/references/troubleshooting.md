...
Use only supported override keys from `stockvaluation.recalculate`. For the default researched workflow, remove unsupported fields and preserve the rejected fields in the explanation; for extra user-requested scenarios, ask the user to restate the scenario using supported fields.
