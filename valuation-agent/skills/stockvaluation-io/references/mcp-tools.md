...
- `stockvaluation.apply_guided_answers` — maps answers from the hidden plan into `userJudgment`, `tickerOverridesCandidate`, and `prospectusScenarioCandidate`; never rebuild mappings by hand.
