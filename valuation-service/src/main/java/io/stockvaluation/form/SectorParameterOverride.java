...
/**
 * Represents a sector-specific parameter override for multi-segment DCF
 * analysis.
 ...
 * Example: Increase "Semiconductors" operating margin by 10% (relative
 * multiplier)
 */
@Data
@NoArgsConstructor
...
public class SectorParameterOverride {
    ...
    /**
     * Name of the sector to override (e.g., "Electronic Components",
     * "Semiconductors")
    ...
    public Double applyOverride(Double currentValue) {
        ...
        return switch (adjustmentType) {
            case "absolute" -> value;
            case "relative_multiplier" -> currentValue * (1.0 + value / 100.0);
            case "relative_additive" -> currentValue + value;
